          ...
          <Card.Body>
            ...
            <div className="mt-14 flex flex-col justify-center items-center gap-y-4">
              ...
              <p className="flex-2 mx-auto max-w-2xl text-center text-xs sm:text-xs text-gray-400 px-4">
                Total repayments ${totalRepayments()}, made up of an
                establishment fee of $
                {toMoneyFormat(calculatedQuote?.establishmentFee)}
                {!calculatedQuote?.totalInterest
                  ? " with interest-free. "
                  : `, interest
            of $${toMoneyFormat(calculatedQuote?.totalInterest)}. `}
                The repayment amount is based on the variables selected, is
                subject to our assessment and suitability, and other important
